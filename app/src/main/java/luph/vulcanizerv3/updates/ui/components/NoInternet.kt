    ...
    Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        Column(
            ...
            Text(
                ...
                modifier = Modifier.padding(horizontal = 16.dp,).padding(top=4.dp).animateContentSize(),
            ...
            Row {
                ...
                Button(onClick = {
                    ...
                    modifier = Modifier.weight(if (shouldNotify.value) 0.00001f else 1f).animateContentSize().padding(horizontal = 16.dp)
                ) {
                    Text("Notify me")
                }
            }
