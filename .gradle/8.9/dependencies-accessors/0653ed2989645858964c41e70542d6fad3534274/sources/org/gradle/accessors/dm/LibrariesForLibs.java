...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>ketch</b>
     * <p>
    ...
    /**
     * Dependency provider for <b>khttp</b> with <b>khttp:khttp</b> coordinates and
     * with version reference <b>khttp</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getKhttp() {
        return create("khttp");
    }

    /**
     * Dependency provider for <b>library</b> with <b>me.zhanghai.compose.preference:library</b> coordinates and
    ...
    /**
     * Dependency provider for <b>pencilloader</b> with <b>io.github.m0coding:pencilloader</b> coordinates and
     * with version reference <b>pencilloader</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getPencilloader() {
        return create("pencilloader");
    }

    /**
     * Dependency provider for <b>twyper</b> with <b>com.github.theapache64:twyper</b> coordinates and
     * with version reference <b>twyper</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getTwyper() {
        return create("twyper");
    }

    /**
     * Dependency provider for <b>versioncompare</b> with <b>io.github.g00fy2:versioncompare</b> coordinates and
     * with version reference <b>versioncompare</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getVersioncompare() {
        return create("versioncompare");
    }
    ...
    /**
     * Group of libraries at <b>jetpack</b>
     */
    public JetpackLibraryAccessors getJetpack() {
        return laccForJetpackLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>photo</b>
     */
    ...
    public static class CoilKtLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>base</b> with <b>io.coil-kt:coil-compose</b> coordinates and
         * with version reference <b>coil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getBase() {
            return create("coil.kt.base");
        }

        /**
         * Dependency provider for <b>compose</b> with <b>io.coil-kt:coil-base</b> coordinates and
         * with version reference <b>coil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>markdown</b> with <b>com.github.jeziellago:compose-markdown</b> coordinates and
         * with version reference <b>composeMarkdown</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class JetpackLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>loading</b> with <b>com.github.MahboubehSeyedpour:jetpack-loading</b> coordinates and
         * with version reference <b>jetpackLoading</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLoading() {
            return create("jetpack.loading");
        }
    ...
    public static class PhotoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compos</b> with <b>io.github.fornewid:photo-compose</b> coordinates and
         * with version reference <b>fornwid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompos() {
            return create("photo.compos");
        }

        /**
         * Dependency provider for <b>zoomable</b> with <b>de.mr-pine.utils:zoomables</b> coordinates and
         * with version reference <b>zoomable</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getZoomable() {
            return create("photo.zoomable");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeMarkdown</b> with value <b>0.5.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeMarkdown() { return getVersion("composeMarkdown"); }

        /**
         * Version alias <b>composeShimmer</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coreKtx</b> with value <b>2.0.2-alpha</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>fornwid</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFornwid() { return getVersion("fornwid"); }

        /**
         * Version alias <b>jetpackLoading</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJetpackLoading() { return getVersion("jetpackLoading"); }

        /**
         * Version alias <b>ketch</b> with value <b>2.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKetch() { return getVersion("ketch"); }

        /**
         * Version alias <b>khttp</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKhttp() { return getVersion("khttp"); }

        /**
         * Version alias <b>konfettiCompose</b> with value <b>2.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxSerializationCore</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktor</b> with value <b>2.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>library</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pencilloader</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPencilloader() { return getVersion("pencilloader"); }
        ...
        /**
         * Version alias <b>translate</b> with value <b>17.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>twyper</b> with value <b>0.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTwyper() { return getVersion("twyper"); }
        ...
        /**
         * Version alias <b>versioncompare</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersioncompare() { return getVersion("versioncompare"); }
        ...
        /**
         * Version alias <b>zoomable</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.corektx</b> with value <b>1.15.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.compose.bom</b> with value <b>2024.11.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxLifecycleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lifecycle.compose</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxLifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lifecycle.runtime.compose</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>google.crashlytics</b> with plugin id <b>com.google.firebase.crashlytics</b> and
         * with version <b>latest.release</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCrashlytics() { return createPlugin("google.crashlytics"); }
